...
<div class="catalog_element">
    ...
    <div class="element_params">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr><td><?php echo GetMessage('MAX_ENGINE_VOLUME') ?></td><td><?php echo $arResult['ENGINE_VOLUME'] ?>&nbsp;см&#179;<?php echo ($arResult['ENGINE_POWER'] ? sprintf('&nbsp;(%s&nbsp;л.с.)', $arResult['ENGINE_POWER']) : '') ?></td></tr>
            <tr><td><?php echo GetMessage('MAX_DISTANCE') ?></td><td><?php echo number_format($arResult['DISTANCE'], '0', '.', ' '), ' ', ('km' == $arResult['DISTANCE_UNIT'] ? 'км' : 'миль'); ?></td></tr>
